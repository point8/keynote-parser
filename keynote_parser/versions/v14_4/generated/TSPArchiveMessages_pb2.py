...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'TSPArchiveMessages_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  DESCRIPTOR._loaded_options = None
  _globals['_MESSAGEINFO'].fields_by_name['version']._loaded_options = None
  _globals['_MESSAGEINFO'].fields_by_name['version']._serialized_options = b'\020\001'
  _globals['_MESSAGEINFO'].fields_by_name['object_references']._loaded_options = None
  _globals['_MESSAGEINFO'].fields_by_name['object_references']._serialized_options = b'\020\001'
  _globals['_MESSAGEINFO'].fields_by_name['data_references']._loaded_options = None
  _globals['_MESSAGEINFO'].fields_by_name['data_references']._serialized_options = b'\020\001'
  _globals['_MESSAGEINFO'].fields_by_name['diff_merge_version']._loaded_options = None
  _globals['_MESSAGEINFO'].fields_by_name['diff_merge_version']._serialized_options = b'\020\001'
  _globals['_MESSAGEINFO'].fields_by_name['diff_read_version']._loaded_options = None
  _globals['_MESSAGEINFO'].fields_by_name['diff_read_version']._serialized_options = b'\020\001'
  _globals['_FIELDINFO'].fields_by_name['object_references']._loaded_options = None
  _globals['_FIELDINFO'].fields_by_name['object_references']._serialized_options = b'\020\001'
  _globals['_FIELDINFO'].fields_by_name['data_references']._loaded_options = None
  _globals['_FIELDINFO'].fields_by_name['data_references']._serialized_options = b'\020\001'
  _globals['_FIELDINFO'].fields_by_name['known_field_version']._loaded_options = None
  _globals['_FIELDINFO'].fields_by_name['known_field_version']._serialized_options = b'\020\001'
  _globals['_FIELDPATH'].fields_by_name['path']._loaded_options = None
  _globals['_FIELDPATH'].fields_by_name['path']._serialized_options = b'\020\001'
  _globals['_COMPONENTINFO'].fields_by_name['document_read_version']._loaded_options = None
  _globals['_COMPONENTINFO'].fields_by_name['document_read_version']._serialized_options = b'\020\001'
  _globals['_COMPONENTINFO'].fields_by_name['document_write_version']._loaded_options = None
  _globals['_COMPONENTINFO'].fields_by_name['document_write_version']._serialized_options = b'\020\001'
  _globals['_COMPONENTINFO'].fields_by_name['component_read_version']._loaded_options = None
  _globals['_COMPONENTINFO'].fields_by_name['component_read_version']._serialized_options = b'\020\001'
  _globals['_COMPONENTINFO'].fields_by_name['component_required_version']._loaded_options = None
  _globals['_COMPONENTINFO'].fields_by_name['component_required_version']._serialized_options = b'\020\001'
  _globals['_COMPONENTINFO'].fields_by_name['ambiguous_object_identifiers']._loaded_options = None
  _globals['_COMPONENTINFO'].fields_by_name['ambiguous_object_identifiers']._serialized_options = b'\020\001'
  _globals['_FEATUREINFO'].fields_by_name['read_version']._loaded_options = None
  _globals['_FEATUREINFO'].fields_by_name['read_version']._serialized_options = b'\020\001'
  _globals['_FEATUREINFO'].fields_by_name['write_version']._loaded_options = None
  _globals['_FEATUREINFO'].fields_by_name['write_version']._serialized_options = b'\020\001'
  _globals['_PACKAGEMETADATA'].fields_by_name['read_version']._loaded_options = None
  _globals['_PACKAGEMETADATA'].fields_by_name['read_version']._serialized_options = b'\020\001'
  _globals['_PACKAGEMETADATA'].fields_by_name['write_version']._loaded_options = None
  _globals['_PACKAGEMETADATA'].fields_by_name['write_version']._serialized_options = b'\020\001'
  _globals['_PACKAGEMETADATA'].fields_by_name['file_format_version']._loaded_options = None
  _globals['_PACKAGEMETADATA'].fields_by_name['file_format_version']._serialized_options = b'\020\001'
  _globals['_PASTEBOARDMETADATA'].fields_by_name['version']._loaded_options = None
  _globals['_PASTEBOARDMETADATA'].fields_by_name['version']._serialized_options = b'\020\001'
  _globals['_PASTEBOARDMETADATA'].fields_by_name['read_version']._loaded_options = None
  _globals['_PASTEBOARDMETADATA'].fields_by_name['read_version']._serialized_options = b'\020\001'
  _globals['_VIEWSTATEMETADATA'].fields_by_name['version']._loaded_options = None
  _globals['_VIEWSTATEMETADATA'].fields_by_name['version']._serialized_options = b'\020\001'
  _globals['_VIEWSTATEMETADATA'].fields_by_name['read_version']._loaded_options = None
  _globals['_VIEWSTATEMETADATA'].fields_by_name['read_version']._serialized_options = b'\020\001'
  _globals['_OBJECTSERIALIZATIONMETADATA'].fields_by_name['version']._loaded_options = None
  _globals['_OBJECTSERIALIZATIONMETADATA'].fields_by_name['version']._serialized_options = b'\020\001'
  _globals['_OBJECTSERIALIZATIONMETADATA'].fields_by_name['read_version']._loaded_options = None
  _globals['_OBJECTSERIALIZATIONMETADATA'].fields_by_name['read_version']._serialized_options = b'\020\001'
  _globals['_DATAPROPERTIESENTRYV1'].fields_by_name['creation_version']._loaded_options = None
  _globals['_DATAPROPERTIESENTRYV1'].fields_by_name['creation_version']._serialized_options = b'\020\001'
  _globals['_ARCHIVEINFO']._serialized_start=52
  _globals['_ARCHIVEINFO']._serialized_end=148
  _globals['_MESSAGEINFO']._serialized_start=151
  _globals['_MESSAGEINFO']._serialized_end=486
  _globals['_FIELDINFO']._serialized_start=489
  _globals['_FIELDINFO']._serialized_end=1148
  _globals['_FIELDINFO_TYPE']._serialized_start=863
  _globals['_FIELDINFO_TYPE']._serialized_end=933
  _globals['_FIELDINFO_UNKNOWNFIELDRULE']._serialized_start=935
  _globals['_FIELDINFO_UNKNOWNFIELDRULE']._serialized_end=1059
  _globals['_FIELDINFO_KNOWNFIELDRULE']._serialized_start=1061
  _globals['_FIELDINFO_KNOWNFIELDRULE']._serialized_end=1148
  _globals['_FIELDPATH']._serialized_start=1150
  _globals['_FIELDPATH']._serialized_end=1179
  _globals['_COMPONENTINFO']._serialized_start=1182
  _globals['_COMPONENTINFO']._serialized_end=1922
  _globals['_COMPONENTEXTERNALREFERENCE']._serialized_start=1924
  _globals['_COMPONENTEXTERNALREFERENCE']._serialized_end=2026
  _globals['_COMPONENTDATAREFERENCE']._serialized_start=2029
  _globals['_COMPONENTDATAREFERENCE']._serialized_end=2215
  _globals['_COMPONENTDATAREFERENCE_OBJECTREFERENCE']._serialized_start=2156
  _globals['_COMPONENTDATAREFERENCE_OBJECTREFERENCE']._serialized_end=2215
  _globals['_OBJECTUUIDMAPENTRY']._serialized_start=2217
  _globals['_OBJECTUUIDMAPENTRY']._serialized_end=2282
  _globals['_FEATUREINFO']._serialized_start=2284
  _globals['_FEATUREINFO']._serialized_end=2370
  _globals['_PACKAGEMETADATA']._serialized_start=2373
  _globals['_PACKAGEMETADATA']._serialized_end=2869
  _globals['_PACKAGEMETADATA_PACKAGETYPE']._serialized_start=2812
  _globals['_PACKAGEMETADATA_PACKAGETYPE']._serialized_end=2869
  _globals['_DOCUMENTREVISION']._serialized_start=2871
  _globals['_DOCUMENTREVISION']._serialized_end=2957
  _globals['_PASTEBOARDMETADATA']._serialized_start=2960
  _globals['_PASTEBOARDMETADATA']._serialized_end=3159
  _globals['_DATAINFO']._serialized_start=3162
  _globals['_DATAINFO']._serialized_end=3889
  _globals['_DATAINFO_DOWNLOADPRIORITY']._serialized_start=3848
  _globals['_DATAINFO_DOWNLOADPRIORITY']._serialized_end=3889
  _globals['_DATAMETADATAMAP']._serialized_start=3892
  _globals['_DATAMETADATAMAP']._serialized_end=4071
  _globals['_DATAMETADATAMAP_DATAMETADATAMAPENTRY']._serialized_start=3985
  _globals['_DATAMETADATAMAP_DATAMETADATAMAPENTRY']._serialized_end=4071
  _globals['_DATAMETADATA']._serialized_start=4073
  _globals['_DATAMETADATA']._serialized_end=4123
  _globals['_ENCRYPTIONINFO']._serialized_start=4125
  _globals['_ENCRYPTIONINFO']._serialized_end=4242
  _globals['_ENCRYPTIONBLOCKINFO']._serialized_start=4244
  _globals['_ENCRYPTIONBLOCKINFO']._serialized_end=4313
  _globals['_VIEWSTATEMETADATA']._serialized_start=4316
  _globals['_VIEWSTATEMETADATA']._serialized_end=4521
  _globals['_OBJECTSERIALIZATIONMETADATA']._serialized_start=4524
  _globals['_OBJECTSERIALIZATIONMETADATA']._serialized_end=4853
  _globals['_OBJECTSERIALIZATIONDIRECTORY']._serialized_start=4856
  _globals['_OBJECTSERIALIZATIONDIRECTORY']._serialized_end=5000
  _globals['_OBJECTSERIALIZATIONDIRECTORY_ENTRY']._serialized_start=4946
  _globals['_OBJECTSERIALIZATIONDIRECTORY_ENTRY']._serialized_end=5000
  _globals['_DATAPROPERTIESENTRYV1']._serialized_start=5003
  _globals['_DATAPROPERTIESENTRYV1']._serialized_end=5179
  _globals['_DATAPROPERTIESV1']._serialized_start=5181
  _globals['_DATAPROPERTIESV1']._serialized_end=5247
  _globals['_DOCUMENTMETADATA']._serialized_start=5249
  _globals['_DOCUMENTMETADATA']._serialized_end=5352
  _globals['_SUPPORTMETADATA']._serialized_start=5355
  _globals['_SUPPORTMETADATA']._serialized_end=5843
  _globals['_SUPPORTMETADATA_DATACOLLABORATIONPROPERTIES']._serialized_start=5498
  _globals['_SUPPORTMETADATA_DATACOLLABORATIONPROPERTIES']._serialized_end=5843
